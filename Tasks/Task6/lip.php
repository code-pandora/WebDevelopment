...
<body style="font-family: 'Noto Sans JP', sans-serif;">
    ...
    <div class="s1 row">
        <div class="card col-sm" id="s">
            <img class="card-img-top" src="lip/lip1.jpg" alt="Card image cap">
            <div class="card-body">
        ...
        <div class="card col-sm" id="s">
            <img class="card-img-top" src="lip/lip2.jpg" alt="Card image cap">
            <div class="card-body">
        ...
        <div class="card col-sm" id="s">
            <img class="card-img-top" src="lip/lip3.jpg" alt="Card image cap">
            <div class="card-body">
    ...
    <div class="s1 row">
        <div class="card col-sm" id="s">
            <img class="card-img-top" src="lip/lip4.jpg" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title"> Kay Beauty</h5>
                <p class="card-text">Upto 20% off + Free Lip Crayon</p>
                <p class="card-text">Worth Rs 799 on orders of Rs.1200</p>
        ...
        <div class="card col-sm" id="s">
            <img class="card-img-top" src="lip/lip5.jpg" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">M.A.C</h5>
                <p class="card-text">Buy 3 Get 3 Free</p>
                <p class="card-text">Pick 3 free gifts on purchse of 3 products</p>
        ...
        <div class="card col-sm" id="s">
            <img class="card-img-top" src="lip/lip6.jpg" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">Maybelline</h5>
                <p class="card-text">Get upto 50% off</p>
                <p class="card-text">"Up your glam quotient!"</p>
    ...
    <div class="s1 row">
        <div class="card col-sm" id="s">
            <img class="card-img-top" src="lip/lip7.png" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title"> Kay Beauty</h5>
                <p class="card-text">Upto 20% off + Free Lip Crayon</p>
                <p class="card-text">Worth Rs 799 on orders of Rs.1200</p>
        ...
        <div class="card col-sm" id="s">
            <img class="card-img-top" src="lip/lip8.jpg" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">M.A.C</h5>
                <p class="card-text">Buy 3 Get 3 Free</p>
                <p class="card-text">Pick 3 free gifts on purchse of 3 products</p>
        ...
        <div class="card col-sm" id="s">
            <img class="card-img-top" src="lip/lip9.jpg" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">Maybelline</h5>
                <p class="card-text">Get upto 50% off</p>
                <p class="card-text">"Up your glam quotient!"</p>
    ...
    <div class="s1 row">
        <div class="card col-sm" id="s">
            <img class="card-img-top" src="lip/lip10.jpg" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title"> Kay Beauty</h5>
                <p class="card-text">Upto 20% off + Free Lip Crayon</p>
                <p class="card-text">Worth Rs 799 on orders of Rs.1200</p>
        ...
        <div class="card col-sm" id="s">
            <img class="card-img-top" src="lip/lip11.jpg" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">M.A.C</h5>
                <p class="card-text">Buy 3 Get 3 Free</p>
                <p class="card-text">Pick 3 free gifts on purchse of 3 products</p>
